...
internal const val LONDON_CITY = "London"
...
internal fun createUser(
        ...
        city: String = LONDON_CITY,
        distance: Double = DISTANCE
) = User(id, firstName, lastName, ip, email, latitude, longitude, city, distance)

internal fun getUsersForLocation(): Set<User> {
    return setOf(
            createUser(firstName = "first", latitude = 51.396910, longitude = -0.241831, city = LONDON_CITY, distance = 0.0),
            createUser(firstName = "second", latitude = 51.443048, longitude = -0.986950, city = LONDON_CITY, distance = 0.0),
            createUser(firstName = "third", latitude = 51.624178, longitude = -0.006850, city = LONDON_CITY, distance = 0.0)
    )
}
...
internal fun getAllUsers(): Set<User> {
    return setOf(
            ...
            createUser(firstName = "fourth", latitude = 51.484830, longitude = -0.1078991, city = LONDON_CITY, distance = 0.0),
...
internal fun getAllLondonUsers(): Set<User> {
    return setOf(
            createUser(firstName = "first", latitude = 51.396910, longitude = -0.241831, city = LONDON_CITY, distance = 10.260782348426675),
            createUser(firstName = "second", latitude = 51.443048, longitude = -0.986950, city = LONDON_CITY, distance = 17.656317391462466),
            createUser(firstName = "third", latitude = 51.624178, longitude = -0.006850, city = LONDON_CITY, distance = 48.19199105586403),
            createUser(firstName = "fourth", latitude = 51.484830, longitude = -0.1078991, city = LONDON_CITY, distance = 9.929874611895507)
    )
}
...
internal fun verify_allLondonUsersHaveBeenRetrieved(users: Collection<User>, targetUsers: Collection<User>) {
    users.size shouldBe targetUsers.size
    verify_allUsersHaveUpdatedDistances(targetUsers)
}